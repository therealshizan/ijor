  ...
  return (
    <Box mx={2} my={2}>
      ...
      <Typography mb={4} align="justify">
        ...
        researchers, practitioners, academicians, and professionals from diverse
        domains to share innovative research achievements. The journal is
        dedicated to publishing high-quality research papers providing
        meaningful insights into any subject area of current interest.
      </Typography>
